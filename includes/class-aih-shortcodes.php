...
class AIH_Shortcodes {
    ...
    public function login_shortcode($atts) {
        ...
        if ($auth->is_logged_in()) {
            ...
            return '<div class="aih-login-success"><p>' . sprintf(__('Welcome, %s! You are already signed in.', 'art-in-heaven'), esc_html($name)) . '</p><button type="button" id="aih-logout" class="aih-btn-secondary">' . __('Sign Out', 'art-in-heaven') . '</button></div>';
        }
