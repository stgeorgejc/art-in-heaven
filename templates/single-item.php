...
<script>(function(){var t=localStorage.getItem('aih-theme');if(t==='dark'){document.currentScript.parentElement.classList.add('dark-mode');}})();</script>
    ...
    <main class="aih-main">
        <div class="aih-single-nav-bar">
            <a href="<?php echo esc_url($gallery_url); ?>" class="aih-back-link">&larr; <span class="aih-back-text"><?php _e('Back to ', 'art-in-heaven'); ?></span><?php _e('Gallery', 'art-in-heaven'); ?></a>
