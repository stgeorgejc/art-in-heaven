        ...
        <div class="aih-wins-grid">
            ...
            <article class="aih-win-card" data-id="<?php echo $item->art_piece_id; ?>">
                <div class="aih-win-image">
                    ...
                    <?php else: ?>
                    <a href="<?php echo esc_url(AIH_Template_Helper::get_art_url($item->art_id)); ?>" class="aih-placeholder-link">
                ...
                <div class="aih-win-body">
                    <h3 class="aih-win-title">
                        <a href="<?php echo esc_url(AIH_Template_Helper::get_art_url($item->art_id)); ?>"><?php echo esc_html($item->title); ?></a>
                    </h3>
