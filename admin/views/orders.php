...
<style>
/* Mark Payment modal styles */
#aih-payment-modal .aih-modal-content {
    background: #fff;
    padding: 20px 30px;
    border-radius: 8px;
    max-width: 500px;
...
#aih-payment-modal .aih-modal-close {
    position: absolute;
    top: 10px;
    right: 15px;
    font-size: 28px;
...
#aih-payment-modal .aih-modal-close:hover {
    color: #000;
}
#aih-payment-modal h2 {
    margin-top: 0;
    padding-right: 30px;
}
</style>
